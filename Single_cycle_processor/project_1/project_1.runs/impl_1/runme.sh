...
HD_PWD='C:/Users/DELL/Single_cycle_processor/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Step_Datapath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Step_Datapath.tcl -notrace
