...
HD_PWD='C:/Users/DELL/Single_cycle_processor/project_1/project_1.runs/synth_1_copy_2'
cd "$HD_PWD"
...
EAStep vivado -log Step_Datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Step_Datapath.tcl
